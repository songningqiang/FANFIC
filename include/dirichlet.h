//This is a general Dirichlet distribution random number generator developed by George Cantwell
//The original code can be found at https://github.com/gcant/dirichlet-cpp
#pragma once
#include <random>
#include <vector>
